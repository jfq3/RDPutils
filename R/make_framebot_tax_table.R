make_framebot_tax_table <- function(clstr_machine="match_cluster_machine_name.txt", taxa_machine="match_taxa_machine_names.txt") {
  clstr_machine <- read.table(file="match_cluster_machine_name.txt", header = FALSE, stringsAsFactors = FALSE, sep="\t")
  taxa_machine <- read.table(file="match_taxa_machine_names.txt", header = FALSE, stringsAsFactors = FALSE, sep="\t")
